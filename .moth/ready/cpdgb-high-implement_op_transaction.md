...
## Summary
Implement OP_Transaction using SQLite's logic as the source of truth.
...
- Add unit tests:
  - Add vdbe transaction state unit tests (autocommit transitions, deferred FK interaction)

- SQLite Tcl tests that should pass before completion:
  - sqlite3/test/trans.test
  - sqlite3/test/savepoint.test
