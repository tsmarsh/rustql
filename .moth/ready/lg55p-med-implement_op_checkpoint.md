...
## Summary
Implement OP_Checkpoint using SQLite's logic as the source of truth.
...
- Add unit tests:
  - Add WAL checkpoint unit tests (PASSIVE/FULL/RESTART if supported)

- SQLite Tcl tests that should pass before completion:
  - sqlite3/test/wal.test
  - sqlite3/test/checkpoint.test
