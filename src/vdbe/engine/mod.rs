            ...
            Opcode::Rewind => {
                ...
                if let Some(cursor) = self.cursor_mut(op.p1) {
                    ...
                    if cursor.is_sqlite_master {
                        ...
                        // Note: SQLite does NOT increment search_count on Rewind.
                        // search_count is only incremented by Seek* and Next/Prev ops.
                        // The Sort opcode decrements search_count to cancel out Rewind.
